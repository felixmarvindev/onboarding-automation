package com.onboarding.identity.config;
...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_NAME = "identity.queue";
    ...
    public Queue identityQueue() {
        return QueueBuilder.durable(QUEUE_NAME)
                ...
                .withArgument("x-dead-letter-routing-key", "identity.dlq")
                .build();
    }

    @Bean
    public Queue identityDlq() {
        return QueueBuilder.durable("identity.dlq").build();
    }

    @Bean
    public Binding identityDlqBinding() {
    ...
    @Bean
    public Binding identityBinding() {
        return BindingBuilder
                .bind(identityQueue())
